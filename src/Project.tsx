...
const Project: React.FC<ProjectProps> = ({ name, description, stars, language }) => {
  return (
    <a href={`https://github.com/playreact/${name}`} target="_blank">
      <div className="h-36 p-5 flex flex-col justify-between rounded-xl bg-info bg-opacity-5 shadow hover:scale-105 hover:bg-opacity-10 ease-out transition-transform">
